...
This creates the remediation layer that future renderer or prompt-revision systems can consume without needing to understand the full validation report shape.
